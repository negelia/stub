...
namespace ClassLibrary1 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeesRow AddEmployeesRow(string Name, string Surname, string Middle_Name) {
...
namespace ClassLibrary1.DataSet1TableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employees] WHERE (([ID_Employees] = @Original_ID_Employees) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ([Middle_Name] = @Original_Middle_Name))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([Name], [Surname], [Middle_Name]) VALUES (@Name, @" +
                "Surname, @Middle_Name);\r\nSELECT ID_Employees, Name, Surname, Middle_Name FROM Em" +
                "ployees WHERE (ID_Employees = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [Name] = @Name, [Surname] = @Surname, [Middle_Name] = @Middle_Name WHERE (([ID_Employees] = @Original_ID_Employees) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ([Middle_Name] = @Original_Middle_Name));
SELECT ID_Employees, Name, Surname, Middle_Name FROM Employees WHERE (ID_Employees = @ID_Employees)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ClassLibrary1.Properties.Settings.Default.basedateConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_Employees, Name, Surname, Middle_Name FROM dbo.Employees";
        ...
        public virtual int Delete(int Original_ID_Employees, string Original_Name, string Original_Surname, string Original_Middle_Name) {
        ...
        public virtual int Insert(string Name, string Surname, string Middle_Name) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Surname, string Middle_Name, int Original_ID_Employees, string Original_Name, string Original_Surname, string Original_Middle_Name, int ID_Employees) {
            if ((Name == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(ID_Employees));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, string Middle_Name, int Original_ID_Employees, string Original_Name, string Original_Surname, string Original_Middle_Name) {
            return this.Update(Name, Surname, Middle_Name, Original_ID_Employees, Original_Name, Original_Surname, Original_Middle_Name, Original_ID_Employees);
        }
    }
